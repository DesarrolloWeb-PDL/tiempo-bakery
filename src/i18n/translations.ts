...
const ES: Translations = {
  ...
  deliveryLocal: "Envío local",
  deliveryLocalDesc: "Entrega a domicilio en tu zona",
  ...
  whatsappFaqLocalDeliveryAnswer: "Sí, ofrecemos reparto local el mismo día del horneado. También hay puntos de recogida.",
...
const PT: Translations = {
  ...
  deliveryLocalDesc: "Entrega a domicilio na sua zona",
  ...
  whatsappFaqLocalDeliveryAnswer: "Sim, oferecemos entrega local no mesmo dia do forno. Também temos pontos de retirada.",
  ...
  whatsappFaqPickupAnswer: "Temos pontos de retirada em diferentes zonas. Você escolhe o mais conveniente ao fazer seu pedido.",
};
...
const EN: Translations = {
  ...
  deliveryLocalDesc: "Home delivery in your area",
  ...
  whatsappFaqLocalDeliveryAnswer: "Yes, we offer local delivery on the same bake day. We also have pickup points.",
