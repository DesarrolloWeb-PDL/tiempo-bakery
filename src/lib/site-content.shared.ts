...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  footerDeliveryText: 'Entrega en punto, reparto local y mensajería urgente el día del horneado.',
  ...
  contactAddress: 'Obrador: Calle Ejemplo 123, Paso de los Libres, Argentina',
  ...
  contactIntro:
    'Escribinos para encargos, dudas sobre la entrega o reparto o. Si necesitás seguimiento de tu pedido, te respondemos por email o WhatsApp.',
  deliveryPickupText:
